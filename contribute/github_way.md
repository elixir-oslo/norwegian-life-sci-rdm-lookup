...
## Share and discuss your proposed through GitHub "issues"
1. Visit our [our GitHub repository](https://github.com/elixir-oslo/biomeddata){:target="_blank"}.
...
4. You can always return to your opened issue by going to the [issues section](https://github.com/elixir-oslo/biomeddata/issues) of our GitHub repo.

{% include callout.html type="tip" content="You can also get to the [pages of this website on GitHub](https://github.com/elixir-oslo/biomeddata) using the 'GitHub' link in the header of this site" %}
...
2. You can now edit or add new text and images according to the provided template. GitHub provide a [guide for writing and formatting in GitHub](https://docs.github.com/en/github/writing-on-github/getting-started-with-writing-and-formatting-on-github). We recommend having a look at the [collection of current domain pages](/pages/cheat_sheets) to understand you how to write a page in the LookUp. Make sure to read our [template](/contentathon/template.md) before start writing. In general, try to avoid manual interlinking of pages from this website.
3. If you have mentioned tools or resources in your text, make sure to add them to the [tool and resource list](/contribute/tool_resource_update). If you want to list training material in your page, add it to the metadata of the page, according to the training matadata fields provided in the page template.
...
8. You can return to your pull request by going to the [pull request section](https://github.com/elixir-oslo/biomeddata/pulls) of our GitHub repo.
...
1. When we (editors) add comments or add a review of your pull request, you will be notified.
...
1. We, editors, are responsible to publish your content.